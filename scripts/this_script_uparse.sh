...
#	6) OTU clusting and chimera detection with UPARSE
##########################################################################################
...
#
#	Before use: $chmod 775 master_uparse.sh
#	To run: $./master_uparse.sh
...
echo %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		mkdir working1
#*****************************************************************************************
# Step1: merge data with usearch9 -fastq-mergepairs
